...
if (isset($_POST['register'])) {
    ...
    $validar = mysqli_query($conn,"SELECT * FROM docentes WHERE Correo='$Email';");
    if(mysqli_num_rows($validar)>0){
        echo "<p class=error>El correo ya esta registrado</p>";
        exit();
    }else{
        $insertar = mysqli_query($conn,"INSERT INTO docentes (`Nombre`,`Apellido1`,`Apellido2`,`Materia`,`Correo`) VALUE ('$Nom','$A1','$A2','$Mat','$Email');");

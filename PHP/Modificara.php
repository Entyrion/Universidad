<?php
    ...
    $stdID=$_GET['ID'];
    $sql="SELECT * FROM alumnos WHERE ID='$stdID';";
    $ress=$conn->query($sql);
    ...
    if(isset($_POST['update'])){
        ...
        $Carr=$_POST['Carrera'];
        $Email=$_POST['Correo'];
        $mod="UPDATE alumnos SET Nombre='$nom', Apellido1='$A1', Apellido2='$A2', Carrera='$Carr', Correo='$Email' WHERE ID='$stdID';";
        $resupd=$conn->query($mod);
        if($resupd==TRUE){
            echo "<br><br><br><p class='success'>Alumno actualizado exitosamente</p>";
        }else{
        ...
        <div class="container-fluid">
            ...
            <form method="post" action="" name="update-form">
                <div class="form-element">
                    <label>ID</label>
                    <input type="text" name="ID" value="<?php echo $stdID; ?>" required disabled />
                </div>
                <div class="form-element">
                    <label>Nombre</label>
                ...
                <div class="form-element">
                    <label>Carrera</label>
                    <input type="text" name="Carrera" value="<?php echo $Carr; ?>" required />
                </div>
                <div class="form-element">
                    <label>Correo</label>
            ...
            <div class="t-30">
            <p><a class="linkreg" href="Consultaa.php">Regresar</a></p>
            </div>

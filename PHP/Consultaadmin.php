<?php
    ...
    $Consultaa="SELECT * FROM administrativos";
                    ...
                    <table class="table mt-5">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a class="btn btn-info" href="Modificaradmin.php?ID=<?php echo $row['ID']; ?>">Edit</a>
                                    <a class="btn btn-danger" href="Deleteadmin.php?ID=<?php echo $row['ID']; ?>">Delete</a>
                                </td>
                            </tr>
                            <?php
                                    }}

<?php
    ...
    $adminID=$_GET['ID'];
    $sql="SELECT * FROM administrativos WHERE ID='$adminID';";
    $ress=$conn->query($sql);
    ...
    if(isset($_POST['update'])){
        ...
        $Puesto=$_POST['Puesto'];
        $Email=$_POST['Correo'];
        $mod="UPDATE administrativos SET Nombre='$nom', Apellido1='$A1', Apellido2='$A2', Correo='$Email', Puesto='$Puesto' WHERE ID='$adminID';";
        $resupd=$conn->query($mod);
        if($resupd==TRUE){
            echo "<br><br><br><p class='success'>Administrativo actualizado exitosamente</p>";
        }else{
...
<html lang="en" dir="ltr">
    <head>
        <meta charset="utf-8">
        <title>Modificar administrativo</title>
        ...
        <div class="container-fluid">
            ...
            <form method="post" action="" name="update-form">
                <div class="form-element">
                    <label>ID</label>
                    <input type="text" name="ID" value="<?php echo $adminID; ?>" required disabled />
                </div>
                <div class="form-element">
                    <label>Nombre</label>
            ...
            <div class="t-30">
            <p><a class="linkreg" href="Consultaadmin.php">Regresar</a></p>
            </div>
